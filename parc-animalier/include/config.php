...
$liste_pages_par_langues = array ( 
				...
				'ca' => array 
					(	'parc_inici' => './contenu/pages/en/park_home.php',
						'pyrenees_animals' => './contenu/pages/en/pyrenees_animals.php',
						'pyrenees_flora' => './contenu/pages/en/pyrenees_flora.php',
						'park_contact' => './contenu/pages/en/park_contact.php',
						'guided_tour' => './contenu/pages/en/guided_tour.php',
...
$textes_affichees_par_langues = array ( 
				...
				'ca' => array 
					(	'titre_site' => 'El Parc dels Angles',
                  ...
                  'cerf' => 'Cérvol',
						...
						'texte_page_galerie' => 'Visita el Parc des de casa! Fes clic a las imatges i navega a través del Parc.',
						...
						'texte_partenaires_site_titre' => 'Partners',
						'texte_partenaires_site_partenaire1' => 'Els Angles',
						'texte_partenaires_site_lien1' => '<a href="http://www.les-angles.com/saison/index.php?option=com_frontpage&Itemid=1" target="_blank">',
						'texte_partenaires_site_partenaire2' => 'Les neiges catalanes',
						...
						'lien_plan_acces' => '<a href="index.php?page=parc_accesso&langue=ca">',
						'lien_contact_parc' => '<a href="index.php?page=parc_contacte&langue=ca">',
