...
<div id="pre-footer">	
	...
	<h5>Plan du site</h5>
        <ul class="checks">
        <li><a href="index.php?page=chemins_parc">Visite guidée</a></li>
        <li><a href="index.php?page=plan_acces">Venir au parc</a></li>
        <li><a href="index.php?page=contact_parc">Écrire au parc</a></li>
        <li><a href="index.php?page=mentions_legales">Mentions légales</a></li>
        </ul>	
   </div>
	<div class="col_6">
	<h5>Partenaires et liens</h5>
        <ul class="checks">
        ...
        <li><a href="./index.php?page=partenaires_parc"><em>Tous nos partenaires ...</em></a></li> 
        </ul>
	</div>
</div>
